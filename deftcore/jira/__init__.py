...
import json
import copy
from deftcore.security.sso import SSOCookies
from deftcore.settings import JIRA_CONFIG, VOMS_CERT_FILE_PATH, VOMS_KEY_FILE_PATH, JIRA_KEY
...
class JIRAClient(object):
    ...
    def log_exception(self, issue_key, exception, log_msg=None):
        try:
            ...
            if logger:
                logger.exception('log_exception failed: {0}'.format(str(ex)))
