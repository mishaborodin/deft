import unittest
from taskengine.models import TaskTemplate, StepExecution, InputRequestList, ProductionTask, TRequest
import time
...
def make_sample_for_slice(request_id, slice_numbers, submit=False):
    ...
    try:
        ...
        for step_id in approved_steps:
            ...
            step.save()
        production_request = TRequest.objects.get(id=request_id)
